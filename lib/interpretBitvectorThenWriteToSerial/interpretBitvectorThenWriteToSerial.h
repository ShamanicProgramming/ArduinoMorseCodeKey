...
/*
- Interprets Morse characters in the bitvector one at a time, sending each through the serial as the corresponding USB HID value for the appropriate ASCII Value or empty space.
*/
